...
description: This Ansible module brings a new level of intelligence to infrastructure automation by combining LangChain with OpenAI LLM. Users can ask complex questions within their playbooks and receive context-aware answers, enhancing decision-making and task efficiency. Ideal for DevOps and IT professionals, this module transforms Ansible into a more adaptive and insightful tool for managing and troubleshooting infrastructure.
...
- name: VLAN Configuration Assistant
  vsantiago113.langchain_ops.llm_openai:
    model: gpt-3.5-turbo
    temperature: 0.3
...
message:
    description: The output message that the llm_openai module generates.
    type: str
    returned: always
...
def run_module():
    ...
    llm = ChatOpenAI(model=module.params['model'], temperature=module.params['temperature'])  # TODO: Need error handling here
